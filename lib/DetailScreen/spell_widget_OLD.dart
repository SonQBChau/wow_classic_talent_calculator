...
class SpellWidgetOLD extends StatefulWidget {
  ...
  @override
  _SpellWidgetOLDState createState() => _SpellWidgetOLDState();
}

class _SpellWidgetOLDState extends State<SpellWidgetOLD> {
  ...
  void _increaseRank(talentPointProvider) {
    if (currentRank < maxRank) {
      currentRank++;
      talentPointProvider.increaseTreePoints(widget.talentTreeName);
      talentPointProvider.increaseTalentPoints(widget.talent, currentRank);
      // print('increase rank');
